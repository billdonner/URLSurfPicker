...
fileprivate protocol URLPickerDelegate:class {
    ...
    var  picksites:[ URL] { get }
}
fileprivate final class URLPickerNavigationController:UINavigationController {
...
fileprivate class URLPickerController:UINavigationController {
...
fileprivate final class URLPickerViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        websites = coordinator?.picksites
        let url = websites[0]
